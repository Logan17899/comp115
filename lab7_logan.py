...
def project_completion_day(day, days_to_completion):
    ...
    Write your docstring
    """
    commence_index = days_week.index(day)
    completion_index = (commence_index + days_to_completion) % 7
...
# Your unit tests
line = '2024-03-05 14:22:15 [ERROR] database.py Connection timeout after 30s'
assert parse_log_line(line) == ('2024-03-05 14:32:15', 'ERROR', 'database.py', 'Connection timeout after 30s')
