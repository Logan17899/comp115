...
day_today = int(input("Enter today's day number (0=Mon, 6=Sun): "))
days_trip = int(input("Enter the number of days for the trip: "))
day_after_trip = (day_today + days_trip) % 7
print(f"Your trip starts on day {day_today}, lasts {days_trip} days. You are back on day {day_after_trip}.")
